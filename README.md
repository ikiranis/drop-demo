...
- Εκτελέστε την γράφοντας στο terminal ``java -jar drop-0.1.0.jar`` ή κάνοντας διπλό κλικ στο αρχείο jar. Στο terminal θα εμφανιστεί το url της εφαρμογής. Συγκεκριμένα είναι το **http://localhost:9999/**.
